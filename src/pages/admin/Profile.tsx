      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">مدیریت اطلاعات شخصی و تنظیمات حساب</p>
          </div>
          <button 
                ...
                {isEditing && (
                  <div className="space-y-3">
                    ...
                    <label 
                      ...
                      className="bg-blue-500 text-white px-4 py-2 rounded-lg font-bold hover:bg-blue-600 transition-colors duration-300 cursor-pointer inline-flex items-center space-x-reverse space-x-2"
                    >
                    ...
                    {(profileData.avatar || profileData.avatarUrl) && (
                      <button
                        ...
                        className="bg-red-500 text-white px-4 py-2 rounded-lg font-bold hover:bg-red-600 transition-colors duration-300 inline-flex items-center space-x-reverse space-x-2 mr-2"
                      >
                        <X className="w-4 h-4" />
                        <span>حذف عکس</span>
                      </button>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-xl bg-gray-100"
                    disabled
                  />
                </div>
            ...
            {isEditing && (
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    <label className="block text-gray-700 font-bold mb-2">تکرار رمز عبور جدید</label>
                    <input
                      type="password"
